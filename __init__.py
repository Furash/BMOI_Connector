...
def update_category(self, context):
    ...
    try:
        ...
        VIEW3D_PT_BMOI3D.bl_category = context.preferences.addons[
            "BMOI_Connector"
...
class BMOI3D_AddonPreferences(AddonPreferences):
    ...
    def draw(self, context):
        ...
        col.label(
            text="Select custom BMOI3D exchange folder(When field is empty path is C:/Users/USERNAME/Local/Temp/BMOI)"
        )
